...
const TRANSLATIONS = {
  ...
  en: {
    ...
    ss_3: 'Reach Higher',
    ss_4: 'Unlock Your Potential',
    ss_5: 'Take Risks',
    ss_6: 'Find New Friends',
    ss_7: 'Find Your Way Home',
  ...
  ro: {
    ...
    ss_3: 'Țintește Mai Sus',
    ss_4: 'Deblochează-ți Potențialul',
    ss_5: 'Asumă-ți Riscuri',
    ss_6: 'Găsește Noi Prieteni',
    ss_7: 'Găsește Drumul Acasă',
  ...
  es: {
    ...
    ss_3: 'Apunta Más Alto',
    ss_4: 'Desbloquea Tu Potencial',
    ss_5: 'Arriésgate',
    ss_6: 'Encuentra Nuevos Amigos',
    ss_7: 'Encuentra el Camino a Casa',
  ...
  fr: {
    ...
    ss_3: 'Vise Plus Haut',
    ss_4: 'Libère Ton Potentiel',
    ss_5: 'Prends des Risques',
    ss_6: 'Trouve de Nouveaux Amis',
    ss_7: 'Retrouve le Chemin',
  ...
  pt: {
    ...
    ss_2: 'Explora Mundos Secretos',
    ss_3: 'Mira Mais Alto',
    ss_4: 'Liberta o Teu Potencial',
    ss_5: 'Arrisca-te',
    ss_6: 'Encontra Novos Amigos',
    ss_7: 'Encontra o Caminho de Casa',
  ...
  ru: {
    ...
    ss_3: 'Цельсь Выше',
    ss_4: 'Раскрой Свой Потенциал',
    ss_5: 'Рискуй',
    ss_6: 'Найди Новых Друзей',
    ss_7: 'Найди Путь Домой',
